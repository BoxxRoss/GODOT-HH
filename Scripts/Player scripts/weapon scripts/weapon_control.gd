...
var bullet_speed_lightnin_ball = 300
...
var lightnin_ball_sprite = preload("res://Sprites/energy_ball.png")
...
func buildup_light_ball():
	if $projecitlepoint/Light2D.texture_scale < 5:
		$projecitlepoint/Light2D.texture_scale += 0.1
